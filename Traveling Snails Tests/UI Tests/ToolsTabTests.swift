...
struct ToolsTabTests {
    ...
    func resetAllDataIntegrationTest() async throws {
        ...
        #expect(tripsAfterReset.count == 0, "All trips should be deleted after reset - THIS WILL FAIL INITIALLY proving the bug")
        #expect(addressesAfterReset.count == 0, "All addresses should be deleted after reset - THIS WILL FAIL INITIALLY proving the bug")
    ...
    func currentResetBehaviorOnlySimulates() async throws {
        ...
        let _ = ToolsTab(modelContext: context) { }
