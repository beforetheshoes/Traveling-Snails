...
final class MockSyncService: SyncService, Sendable {
    ...
    var isSyncing: Bool {
        return lock.withLock { _isSyncing }
    }
    
    var lastSyncDate: Date? {
        return lock.withLock { _mockLastSyncDate }
    }
    
    var syncError: Error? {
        return lock.withLock { _mockSyncError }
    }
    
    var pendingChangesCount: Int {
        return lock.withLock { _mockPendingChangesCount }
    }
    
    var syncProtectedTrips: Bool {
        get { 
            return lock.withLock { _syncProtectedTrips }
        }
        set { 
    ...
    func getTriggerSyncCallCount() -> Int {
        return lock.withLock { _triggerSyncCallCount }
    }
    
    func getTriggerSyncAndWaitCallCount() -> Int {
        return lock.withLock { _triggerSyncAndWaitCallCount }
    }
    
    func getProcessPendingChangesCallCount() -> Int {
        return lock.withLock { _processPendingChangesCallCount }
    }
    
    func getNetworkInterruptionSimulationCount() -> Int {
        return lock.withLock { _networkInterruptionSimulationCount }
    }
}
