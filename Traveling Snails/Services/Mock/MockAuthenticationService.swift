...
final class MockAuthenticationService: AuthenticationService, Sendable {
    ...
    var isEnabled: Bool {
        return lock.withLock { _mockIsEnabled }
    }
    
    var biometricType: BiometricType {
        return lock.withLock { _mockBiometricType }
    }
    
    func canUseBiometrics() -> Bool {
        return lock.withLock { _mockCanUseBiometrics }
    }
    ...
    var allTripsLocked: Bool {
        ...
        return lock.withLock { _authenticatedTripIDs.isEmpty }
    }
